                    ...
                    <div class="card"
                        ...
                        <form action="" method="GET" id="form_id">
                            <select id="tahun" name="tahun" onChange="document.getElementById('form_id').submit();"
                                style="width:90px; height:30px; margin-right:30px;">
                                <option value="" disabled>Pilih Tahun</option>
                                <option
                                    <?php if(!empty($tahuntampil)){ echo $tahuntampil == '2019' ? 'selected':''; } ?>
                                    value="2019">2019</option>
                                <option
                                    <?php if(!empty($tahuntampil)){ echo $tahuntampil == '2020' ? 'selected':''; } ?>
                                    value="2020">2020</option>
                                <option
                                    <?php if(!empty($tahuntampil)){ echo $tahuntampil == '2021' ? 'selected':''; } ?>
                        ...
                        echo "<a href='export_excel_project_mandays.php' class='btn btn-success btn-sm active' role='button'
                            aria-pressed='true' style='height:30px; width: 90px; font-size: 14px; padding: 3px 0px 0px 0px;'>EXPORT</a>";
                        ?>
                        </form>
                    </div>
                    <div class="card"
...
?>
     ...
     $no = 1;
      ...
      ?>
                                <tr>
                                    <td><a
                                            href="detail_project.php?id=<?=$Sum2['id']?>"><?php echo $Sum2['project']?></a>
                                    </td>
                                    ...
                                    <td><a href="edit_project_mandays.php?project_id=<?=$Sum2['id']?>"><i
