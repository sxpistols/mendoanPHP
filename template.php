...
$Sum2=$result2['karyawan'];
 ?>
   <table id="example" class="table" style="width:100%">
    ...
    <tr>
             <td><?php echo $no ?></td>
             <td><a href="detail_karyawan.php?user_id=<?=$Sum2[$a]['user_id']?>"><?php echo $Sum2[$a]['fullname']?></td>
             <td><?php echo $Sum2[$a]['nik']?></td>
             <td><?php echo $Sum2[$a]['year']?> Tahun <?php echo $Sum2[$a]['month']?> Bulan <?php echo $Sum2[$a]['day']?> Hari</td>
